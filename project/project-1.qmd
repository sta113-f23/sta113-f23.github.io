...
-   A plan for answering the question, including the variables involved, variables to be created (if any), external data to be merged in (if any) as well as the types of plots you're planning to make.
