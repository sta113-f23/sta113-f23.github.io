...
If there are circumstances that prevent you from completing a homework assignment by the stated due date, you may email the TA (Shelby Tisdale, [shelby.tisdale\@duke.edu](mailto:shelby.tisdal@duke.edu)) before the deadline to waive the late penalty. In your email, you only need to request the waiver; you do not need to provide explanation. This waiver may only be used for **once** in the semester, so only use it for a truly extenuating circumstance.
