...
The dataset has `r nrow(statsci)` rows and `r ncol(statsci)` columns.
...
The remaining columns show the number of students graduating with that major in a given academic year from 2011 to 2021.
