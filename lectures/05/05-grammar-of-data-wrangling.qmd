...
-   HW 1 due next today at 5 pm
-   Subsequent HW deadlines adjusted accordingly
-   Next week:
    -   Tuesday: Project 1 workday
    -   Thursday: Rubenstein Lubrary rare collections visit
...
-   Clone the repo in Posit Cloud, open the Quarto document in the repo, set up a new PAT, and then run `git config credential.helper store` in the Terminal.
